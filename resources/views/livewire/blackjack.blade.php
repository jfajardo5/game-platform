<div x-data="game()" class="mx-auto overflow-hidden bg-white shadow-xl max-w-7xl sm:px-6 lg:px-8 sm:rounded-lg">
    ...
    <div class="flex flex-row flex-wrap items-center justify-center p-8 text-center sm:justify-between">
        <span class="text-xl">Dealer Score: {{ $dealerScore }} pts</span>
        <span class="text-xl">Player Score: {{ $playerScore }} pts</span>
    </div>
    ...
    <div class="flex flex-col items-center justify-center">
        <div x-show.transition="gameIsOver" class="fixed z-10 flex flex-col items-center justify-center w-64 px-6 py-4 m-4 text-center text-green-700 bg-green-100 border border-green-400 rounded-lg shadow-xl lg:w-96 animate__animated animate__backInDown" role="alert">
                <strong class="text-xl font-bold lg:text-3xl">{{ $flashMessage }}</strong>
